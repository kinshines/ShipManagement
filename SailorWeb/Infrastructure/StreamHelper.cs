...
namespace SailorWeb.Infrastructure
{
    public class StreamHelper
    {
        ...
        public static byte[] Image2ByteWithPath(string imagePath)
        {
            ...
            {
                logger.Error("StreamHelper.Image2ByteWithPath 异常", ex);
                return null;
            }
        }
        ...
        public static Image BytToImg(byte[] byt)
        {
            ...
            {
                logger.Error("StreamHelper.BytToImg 异常", ex);
                return null;
            }
        }
        ...
        public static Image Url2Img(string imageUrl)
        {
            ...
            {
                logger.Error("StreamHelper.Url2Img 异常", ex);
            }
        ...
        public static Image ImagePath2Img(string imagePath)
        {
            ...
            {
                logger.Error("StreamHelper.ImagePath2Img 异常", ex);
                return null;
            }
        }
    }
