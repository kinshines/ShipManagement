...
namespace SailorWeb.Controllers
{
    ...
    public class VesselController : Controller
    {
        ...
        public VesselController(IVesselService vesselService, IShipownerService shipownerService)
        {
        ...
        public ActionResult Create()
        {
            ...
            if (String.IsNullOrWhiteSpace(Request.QueryString["VesselManageType"]))
            {
                ViewBag.VesselManageType = VesselManageType.派员船舶;
            }
            else
            {
                ViewBag.VesselManageType = Request.QueryString["VesselManageType"];
            }
