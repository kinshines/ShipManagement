...
namespace SailorWeb.Controllers
{
    ...
    public class UsersAdminController : Controller
    {
        ...
        public UsersAdminController(ISysCompanyService companyService)
        {
            _companyService = companyService;
        }

        public UsersAdminController(ApplicationUserManager userManager, ApplicationRoleManager roleManager,ISysCompanyService companyService)
        {
