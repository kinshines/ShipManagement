...
{
    public class VesselAccountService : AuthorizeBaseService<VesselAccount>
    {
        private readonly IHostingEnvironment env;
        public VesselAccountService(DefaultDbContext cxt, ILogger<VesselAccountService> logger, IHostingEnvironment env) : base(cxt, logger)
        {
            this.env = env;
        }
