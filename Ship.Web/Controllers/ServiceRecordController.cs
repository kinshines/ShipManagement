...
namespace Ship.Web.Controllers
{
    ...
    {
        readonly ServiceRecordService _recordService;
        ...
        public ServiceRecordController(ServiceRecordService recordService, SailorService sailorService,
            VesselService vesselService, ShipownerService shipownerService, ContractService contractService,
            ExperienceService experienceService, SysCompanyService companyService)
        {
        ...
        public ActionResult Create()
        {
            ...
            var VesselID = Request.Query["VesselID"];
        ...
        public ActionResult Create([Bind("ServiceRecordID,Post,SailZone,AboardDate,AboardPlace,AshoreDate,AshorePlace,AshoreReason,Remark,Comment,SailorID,ShipownerID,VesselID,SailorName,ShipownerName,VesselName")] ServiceRecord servicerecord)
        {
        ...
        public ActionResult Edit(int? id)
        {
            ...
            if ("Ashore".Equals(Request.Query["medium"]))
            {
                ViewBag.Title = "船员下船";
            }
