...
namespace Ship.Web.Controllers
{
    ...
    {
        readonly LaborSupplyService _laborSupplyService;
        public LaborSupplyController(LaborSupplyService laborSupplyService)
        {
        ...
        public ActionResult Create([Bind("LaborSupplyID,Name,Specification,Total,Baseline,Remark")] LaborSupply laborsupply)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind("LaborSupplyID,Name,Specification,Total,Baseline,Remark")] LaborSupply laborsupply)
        {
            if (ModelState.IsValid)
            {
