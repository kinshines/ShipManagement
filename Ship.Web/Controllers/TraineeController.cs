...
namespace Ship.Web.Controllers
{
    public class TraineeController : Controller
    {
        ...
        readonly TraineeService _traineeService;
        readonly SailorService _sailorService;
        public TraineeController(TrainingClassService trainingService, TraineeService traineeService, SailorService sailorService)
        {
        ...
        public ActionResult Create([Bind("TraineeID,Expense,ExpenseClaim,CertificateNo,Qualified,Remark,TrainingClassID,SailorID")] Trainee trainee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind("TraineeID,Expense,ExpenseClaim,CertificateNo,Qualified,Remark,TrainingClassID,SailorID")] Trainee trainee)
        {
            if (ModelState.IsValid)
            {
                var sailor = _sailorService.Find(trainee.SailorID);
